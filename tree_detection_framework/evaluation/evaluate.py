...
def match_points(
    ...
    if isinstance(treetop_set_1, gpd.GeoDataFrame):
        treetop_set_1 = RegionDetections(detection_geometries=None, data=treetop_set_1)
    if isinstance(treetop_set_2, gpd.GeoDataFrame):
        treetop_set_2 = RegionDetections(detection_geometries=None, data=treetop_set_2)
